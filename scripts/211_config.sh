...
# 이름 설정 -> 추가시 211_wifi_sts.sh, 211_cur_sts.sh 수정 필요
_NAME1="${_ROUTER} [폰1]"
_NAME2="${_ROUTER} [폰2]"
_NAME3="${_ROUTER} [폰3]"
_NAME4="${_ROUTER} [TAB1]"

# 인식할 휴대폰 MAC이나 공유기에 표시되는 휴대폰 이름 설정
...
# 휴대폰에 WIFI 상태를 어느 텔레그램 전송 할 것인지 설정
_WIFI_CONN_SEND1="1,0,0" #_CHATID1에 전송
_WIFI_CONN_SEND2="1,0,0"
_WIFI_CONN_SEND3="1,1,0" #_CHATID1, _CHATID2 에 전송
